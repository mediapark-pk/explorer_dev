...
import { useStyles } from 'src/pages/delegates/component/RatingMap/components/MapPointsWrapper/style';
import MapPoint from 'src/pages/delegates/component/RatingMap/components/MapPoint';
