...
import { useStyles } from 'src/pages/delegates/component/MainTable/components/AllDelegatesTable/components/TableHeader/style';
...
interface IAllTableHeaderProps {}

const AllTableHeader: React.FC<IAllTableHeaderProps> = ({ }) => {
