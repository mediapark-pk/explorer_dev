...
import { useStyles } from 'src/pages/delegate/component/DropDown1/style';
import Typography from '@material-ui/core/Typography';

interface IDropDown1Props {
}

const DropDown1: React.FC<IDropDown1Props> = ({ }) => {
    ...
    return (
        <div className={classes.root} >
            ...
            <div className={classes.custom2512451} >
