...
import { useStyles } from 'src/pages/address/backlog/Transactions11/style';
import DelegatesBlock2 from 'src/pages/address/backlog/DelegatesBlock2';
...
import TableRowDelegates12 from 'src/pages/address/backlog/TableRowDelegates12';
