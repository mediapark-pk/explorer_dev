...
import { useStyles } from 'src/pages/address/backlog/Delegates12/style';
import DelegatesBlock from 'src/pages/address/backlog/DelegatesBlock';
...
import TableRowDelegates from 'src/pages/address/backlog/TableRowDelegates';
