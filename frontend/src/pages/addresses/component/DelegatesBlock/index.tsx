...
import { useStyles } from 'src/pages/addresses/component/DelegatesBlock/style';
import Typography from '@material-ui/core/Typography';

interface IDelegatesBlockProps {
}

const DelegatesBlock: React.FC<IDelegatesBlockProps> = ({ }) => {
    const classes = useStyles({});

    return (
        <div className={classes.root} >
            <div className={classes.custom25122520} >
