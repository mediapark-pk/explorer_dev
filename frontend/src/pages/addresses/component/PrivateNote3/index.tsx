...
import { useStyles } from 'src/pages/addresses/component/PrivateNote3/style';
import Typography from '@material-ui/core/Typography';

interface IPrivateNote3Props {
}

const PrivateNote3: React.FC<IPrivateNote3Props> = ({ }) => {
    ...
    return (
        <div className={classes.root} >
            <div className={classes.div} >
                ...
                <div className={classes.custom25123048} >
