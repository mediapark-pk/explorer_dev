...
import { useStyles } from 'src/pages/addresses/component/PrivateNote1/style';
import Typography from '@material-ui/core/Typography';

interface IPrivateNote1Props {
}

const PrivateNote1: React.FC<IPrivateNote1Props> = ({ }) => {
    ...
    return (
        <div className={classes.root} >
            <div className={classes.div} >
                ...
                <div className={classes.custom25122991} >
