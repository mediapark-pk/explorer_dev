...
import { useStyles } from 'src/pages/addresses/component/PrivateNote4/style';
import Typography from '@material-ui/core/Typography';

interface IPrivateNote4Props {
}

const PrivateNote4: React.FC<IPrivateNote4Props> = ({ }) => {
    ...
    return (
        <div className={classes.root} >
            <div className={classes.div} >
                ...
                <div className={classes.custom25123057} >
