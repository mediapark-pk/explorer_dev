...
import { useStyles } from 'src/pages/addresses/component/TableRowDelegates4/style';
import TableCell from '@material-ui/core/TableCell';
import Typography from '@material-ui/core/Typography';

interface ITableRowDelegates4Props {
    item?: any;
}

const TableRowDelegates4: React.FC<ITableRowDelegates4Props> = ({ item, }) => {
...
export default TableRowDelegates4;
