...
import { useStyles } from 'src/pages/transaction/component/DropDown6/style';
import Typography from '@material-ui/core/Typography';

interface IDropDown6Props {
}

const DropDown6: React.FC<IDropDown6Props> = ({ }) => {
    ...
    return (
        <div className={classes.root} >
            ...
            <div className={classes.custom1831046} >
